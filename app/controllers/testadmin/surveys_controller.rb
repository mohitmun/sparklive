class Testadmin::SurveysController < ApplicationController
  ...
  def params_whitelist
    params.require(:survey_survey).permit(Survey::Survey::AccessibleAttributes.push(:module_brief, :topics_covered, :learning_objectives, :faculty, :youtube_url, :video_brief))
  end
